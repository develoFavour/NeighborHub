		...
		>
			...
			<div className="relative z-10 space-y-4 md:space-y-5 lg:space-y-6 mb-6 md:mb-7 lg:mb-9 max-w-md md:max-w-[500px] lg:max-w-[588px] mt-16 md:mt-[120px] lg:mt-[160px] px-4">
				<h1 className="text-foreground text-3xl md:text-4xl lg:text-6xl font-semibold leading-tight">
					Share Everything, Own Nothing
				</h1>
				<p className="text-muted-foreground text-base md:text-base lg:text-lg font-medium leading-relaxed max-w-lg mx-auto">
					Connect with neighbors to borrow, lend, and share tools, books, and
					equipment. Build community while saving money and space.
				</p>
			</div>

			<Link href="/auth/register">
				<Button className="relative z-10 cursor-pointer bg-secondary text-secondary-foreground hover:bg-secondary/90 px-8 py-3 rounded-full font-medium text-base shadow-lg ring-1 ring-white/10">
					Join for free
				</Button>
			</Link>
		</section>
